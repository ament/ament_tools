...
from ament_tools.commands.test_pkg import test_pkg_parser
from ament_tools.commands.test_pkg import run_command


def main(args):
    parser = test_pkg_parser('ament_cmake')
    ...
    try:
        ...
        # invoke make test if Makefile contains a test target
        with open(os.path.join(build_prefix, 'Makefile')) as f:
            content = f.read()
